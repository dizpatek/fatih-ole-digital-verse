      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div className="relative">
              <Sparkles className="w-6 h-6 text-primary group-hover:text-secondary transition-colors duration-300" />
              <div className="absolute inset-0 blur-lg bg-primary/50 group-hover:bg-secondary/50 transition-colors duration-300" />
            </div>
            <span className="gradient-text-primary">Fatih Sontürk</span>
          </NavLink>
          ...
          <div className="hidden md:flex items-center gap-1">
              ...
              >
                {({ isActive }) => (
                  <>
                    ...
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-primary to-secondary group-hover:w-full transition-all duration-300" />
                  </>
                )}
              </NavLink>
            ))}
            ...
            <button
              ...
              className="ml-4 relative group px-5 py-2.5 rounded-full font-medium text-sm overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-green-600 transition-all duration-300 group-hover:scale-105" />
          ...
          >
            ...
            <div className={`absolute inset-0 flex items-center justify-center transition-all duration-300 ${isOpen ? 'rotate-0 opacity-100' : '-rotate-180 opacity-0'}`}>
              <X size={24} />
            </div>
          </button>
        </div>
        ...
        <div className={`md:hidden overflow-hidden transition-all duration-500 ease-out ${
          ...
          <div className="py-4 space-y-1 border-t border-border/50">
            ...
            <button
              onClick={handleWhatsAppClick}
              className="w-full mt-2 py-3 px-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg font-medium flex items-center justify-center gap-2 hover:from-green-400 hover:to-green-500 transition-all duration-300"
            >
